...
### 指导规范
- [新人入职](newplayer.md)
- [客户端人员分工参考](dh_work/深圳客户端人员分工参考.md)
- [工程简介](dh_work/工程简介)
- [热更新编码规范](dh_work/热更新编码规范)
- [热更包生成及发布流程](dh_work/热更包生成及发布流程)
- [定位 Bugly 报错](dh_work/定位Bugly报错)
- [子游戏开发及交付对接规范](dh_work/子游戏开发及交付对接规范)
...
### 功能说明
- [psd2node插件使用方法](dh_work/psd2node)
- [子游戏移植工具使用方法](dh_work/子游戏移植工具)
